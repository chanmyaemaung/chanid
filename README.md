...
<script type="module">
  import chanid from 'https://cdn.jsdelivr.net/npm/chanid@1.2.4/dist/chanid.mjs';
...
<script nomodule src="https://cdn.jsdelivr.net/npm/chanid@1.2.4/dist/chanid.min.js"></script>
```
